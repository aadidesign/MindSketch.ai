...
const Navbar = () => {
  ...
  const {user ,setShowLogin, logout, credit} = useContext(AppContext) // Accessing user from AppContext
    ...
    <div className='flex justify-between items-center py-4'>
      ...
      <div>
          ...
          <div className='flex items-center gap-2 sm:gap-3'>
            ...
            <p className='text-xm sm:text-sm font-medium text-gray-600'>Credit left : {credit}</p>
            </button>
