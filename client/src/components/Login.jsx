...
const Login = () => {
    ...
    const onSubmitHandler = async (e) => {
        e.preventDefault();
        try{
            console.log('Attempting:', state, 'with backendUrl:', backendUrl);
    ...
    // useEffect to prevent body SCROLL when modal of Login or Signup page is open
    useEffect(() => {
    ...
    <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
        ...
        className='relative bg-white p-10 rounded-xl text-slate-500'>
            ...
            {state !== 'Login' && <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
                <img className="w-6 h-6 object-contain" src={assets.profile_icon} alt=""/>
            ...
            {/* Only Profile icon required className properties to give! */}
